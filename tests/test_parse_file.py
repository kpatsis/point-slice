...
from points_slice import Point3D, SliceType, PointsSlice
...
class TestDetectSliceType(unittest.TestCase):
    ...
    def test_unknown_slice_detection(self):
        ...
        points = [Point3D(i*0.1, j*0.1, k*0.1) for i in range(10) for j in range(10) for k in range(10)]
        result = detect_slice_type_from_data(points)
    ...
    def test_custom_threshold(self):
        ...
        points = [Point3D(i, j, 5.0 + k*0.01) for i in range(5) for j in range(5) for k in range(3)]
